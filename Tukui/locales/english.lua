...
L.TukuiInstall_page1_desc1 = "This install process will help you learn some of the features in Tukui has to offer and also\n prepare your user interface for usage."
...
L.TukuiInstall_page3_desc2 = "Please click the button below to setup your chat windows. You will have to finish the\n installation process for the chat tabs to correct themselves."
L.TukuiInstall_page3_button1 = "Setup Chat"

L.TukuiInstall_page4_subtitle = "Resolution"
L.TukuiInstall_page4_desc1 = "Your current resolution is: %s, Tukui has automatically selected the %s version for\n you based on your screen size."
L.TukuiInstall_page4_desc2 = "This controls various settings including how the actionbars are displayed and the scale of the\n unitframes. You can change this setting by using the in-game config (/oui) and setting the\n resolution override to what you want."
L.TukuiInstall_Low = "Low"
L.TukuiInstall_High = "High"

L.TukuiInstall_page5_subtitle = "Action Bars"
L.TukuiInstall_page5_desc1 = "Once the installation process is complete you will be able to setup your actionbars. This can be\n done by clicking the 'L' button that is located on the right side of the left chat panel."
L.TukuiInstall_page5_desc2 = "You can quickly setup your actionbar keybinds by using the /hb command. You can move the\n action buttons around by holding 'shift' and dragging a button."

L.TukuiInstall_page6_subtitle = "UnitFrames"
L.TukuiInstall_page6_desc1 = "Once the installation process is complete you will be able to reposition your unitframes. This can be done by\n clicking the 'L' button that is located on the right side of the left chat panel."
...
L.TukuiInstall_page7_desc1 = "You are now finished with the installation process. If you are in need technical support please\n visit us at http://www.tukui.org/forums/forum.php?id=50."
