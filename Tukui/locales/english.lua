...
L.core_welcome2 = "Type |cff1784d1/uihelp|r for more info, type |cff1784d1/oui|r to config, or visit http://www.tukui.org/forums/forum.php?id=50 for more information!"
...
L.TukuiInstall_Title = "Tukui Installation"
L.TukuiInstall_ContinueMessage = "Please press the continue button to go onto the next step."
L.TukuiInstall_HighRecommended = "Importance: |cff07D400High|r"
L.TukuiInstall_MediumRecommended = "Importance: |cffD3CF00Medium|r"

L.TukuiInstall_page1_subtitle = "Welcome to OdineUI %s (Tukui version %s!)"
L.TukuiInstall_page1_desc1 = "This install process will help you learn some of the features in Tukui has to offer and also prepare your user interface for usage."
L.TukuiInstall_page1_desc2 = "You can type the /uihelp command to display a list of commands. The in-game configuration menu can be accessed with /oui. Press the button below if you wish to skip the installation process."
L.TukuiInstall_page1_button1 = "Skip Process"

L.TukuiInstall_page2_subtitle = "CVars and Window Positions"
L.TukuiInstall_page2_desc1 = "This part of the installation process sets up your World of Warcraft default options it is recommended you should do this step for everything to behave properly."
...
L.TukuiInstall_page3_desc1 = "This part of the installation process sets up your chat windows names, positions and colors."
L.TukuiInstall_page3_desc2 = "Please click the button below to setup your chat windows. You will have to finish the installation process for the chat tabs to correct themselves."
L.TukuiInstall_page3_button1 = "Setup Chat"

L.TukuiInstall_page4_subtitle = "Resolution"
L.TukuiInstall_page4_desc1 = "Your current resolution is: %s, Tukui has automatically selected the %s version for you based on your screen size."
L.TukuiInstall_page4_desc2 = "This controls various settings including how the actionbars are displayed and the scale of the unitframes. You can change this setting by using the in-game config (/oui) and setting the resolution override to what you want."
L.TukuiInstall_Low = "Low"
L.TukuiInstall_High = "High"

L.TukuiInstall_page5_subtitle = "Action Bars"
L.TukuiInstall_page5_desc1 = "Once the installation process is complete you will be able to setup your actionbars. This can be done by clicking the 'L' button that is located on the right side of the left chat panel."
L.TukuiInstall_page5_desc2 = "You can quickly setup your actionbar keybinds by using the /hb command. You can move the action buttons around by holding 'shift' and dragging a button."

L.TukuiInstall_page6_subtitle = "UnitFrames"
L.TukuiInstall_page6_desc1 = "Once the installation process is complete you will be able to reposition your unitframes. This can be done by clicking the 'L' button that is located on the right side of the left chat panel."
L.TukuiInstall_page6_desc2 = "You can quickly swap between DPS and Healer layouts by typing the /dps and /heal commands."
L.TukuiInstall_page6_desc3 = "If you wish to set the unitframe positions to their default spot please click the button below"
L.TukuiInstall_page6_button1 = "Set UnitFrame Position"

L.TukuiInstall_page7_subtitle = "Installation Complete"
L.TukuiInstall_page7_desc1 = "You are now finished with the installation process. If you are in need technical support please visit us at http://www.tukui.org/forums/forum.php?id=50."
L.TukuiInstall_page7_desc2 = "Please click the button below so you can setup variables and ReloadUI."
L.TukuiInstall_page7_button1 = "Finished"
L.TukuiInstall_CVarSet = "CVars Set"
L.TukuiInstall_ChatSet = "Chat Positions Set"
L.TukuiInstall_UFSet = "UnitFrame Positions Set"