...
function EmbedSkada()
	if #windows == 1 then
		EmbedWindow(windows[1], C["chat"].width - 4, (C["chat"].height - (barSpacing * 5)) / 8, C["chat"].height, "TOPRIGHT", ChatRBackground, "TOPRIGHT", -2, -2)
	elseif #windows == 2 then
		EmbedWindow(windows[1], ((C["chat"].width - 4) / 2) - (borderWidth + T.mult), (C["chat"].height - (barSpacing * 5)) / 8, C["chat"].height,  "TOPRIGHT", ChatRBackground, "TOPRIGHT", -2, -2)
		EmbedWindow(windows[2], ((C["chat"].width - 4) / 2) - (borderWidth + T.mult), (C["chat"].height - (barSpacing * 5)) / 8, C["chat"].height,  "TOPLEFT", ChatRBackground, "TOPLEFT", 2, -2)
	elseif #windows > 2 then
		EmbedWindow(windows[1], ((C["chat"].width - 4) / 2) - (borderWidth + T.mult), (C["chat"].height - (barSpacing * 5)) / 8, C["chat"].height,  "TOPRIGHT", ChatRBackground, "TOPRIGHT", -2, -2)
		EmbedWindow(windows[2], ((C["chat"].width - 4) / 2) - (borderWidth + T.mult), (C["chat"].height - (barSpacing * 8)) / 8, C["chat"].height / 2,  "TOPLEFT", ChatRBackground, "TOPLEFT", 2, -2)
...
if C["addonskins"].embed == "Skada" then
	...
	local ctab = CreateFrame("Frame", "TukuiEmbedBar", ChatRBackground)
	...
	x:SetScript("OnEvent", function(self, event)
		...
		local ctab = CreateFrame("Frame", "TukuiAddonBar", ChatRBackground)
		ctab:SetHeight(T.Scale(22))
		ctab:SetWidth(T.Scale(C["chat"].width))
		ctab:SetFrameLevel(3)	
		ctab:SetPoint("TOPLEFT", 0, 25)
